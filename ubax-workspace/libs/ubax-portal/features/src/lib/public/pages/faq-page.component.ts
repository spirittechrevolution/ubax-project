...
import { UiAccordionComponent, UiAccordionItem, UiButtonComponent, UiCardComponent } from '@ubax-workspace/shared-ui';

@Component({
  selector: 'ubax-faq-page',
  imports: [PublicShellComponent, UiAccordionComponent, UiButtonComponent, UiCardComponent],
  ...
  protected readonly items: UiAccordionItem[] = [
    {
      ...
      content: 'UBAX est une application web de gestion immobiliere destinee aux agences.',
    },
    {
